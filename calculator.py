...
"""Функция определяющая знак и производящая математическое вычисление.
    Args: 
        result - Результат вычислений предыдущего действия.
        sign - Математическая операция производимая с числами.
        digit - Число с которым необходимо провести математическое действие.
    Return: 
        Вычисленное новое значение result.
    """
